...
#  /opt/homebrew/bin/kasa --host $device_ip_address on >> /Users/$user/oversight/toggle_kasa.log
else
...
#  /opt/homebrew/bin/kasa --host $device_ip_address off >> /Users/$user/oversight/toggle_kasa.log
  camera=0
  microphone=0
fi
